...
const img_nuevo = document.createElement('img');
img_nuevo.src = "https://vectorseek.com/wp-content/uploads/2023/10/SENATI-Logo-Vector.svg-.png";

div_nuevo.appendChild(img_nuevo);
contenedor.appendChild(div_nuevo);

//ACTIVIDAD DE CLASE

let parrafo_nuevo = document.createElement('p');
parrafo_nuevo.textContent = "ñsahfñoSHGODAHGOIDAHGOIDAHGOIERAHGOIARHGODAHGOIEAHGHRGOIAHOIJrohjERWJHOEirjhoih";

let div_parrafo = document.createElement('div');
div_parrafo.appendChild(parrafo_nuevo);

let h6_nuevo = document.createElement('h6');

h6_nuevo.textContent = "HGÑOhgoiheOIGBHOIEHBOIRAHBOIRAHPOB";
